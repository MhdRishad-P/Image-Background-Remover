...
const Pricing = () => {
  return (
    <div className='py-10  md:px-20 lg:p-20'>
                    ...
                    <div className="text-center p-6">
                        ...
                        <div className="px-4 pb-8">
                            <ul className="mb-8 space-y-4">
                                ...
                                bg-gradient-to-r from-purple-500 to-indigo-500 shadow-lg hover:from-purple-600 hover:from-purple-600 hover:to-indigo-600
