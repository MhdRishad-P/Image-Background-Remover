  ...
  return (
    <nav className='bg-white px-8 py-4 flex justify-between items-center'>
        ...
        <SignedIn>
                ...
                <button className="flex items-center gap-2 bg-blue-100 px-4 sm:px-5 py-1 sm:py-2 5 rounded-full hover:scale-105 transition-all duration-500 cursor-pointer max-sm:hidden">
                    <img src={assets.credits} alt="credits" height={24} width={24}/>
                    <p className="text-xs sm:text-sm font-medium text-gray-600 max-sm:hidden">
                        Credits : 0
                    </p>
                </button>
